...
@Component({
  selector: 'app-hospital-bill-master-form',
  templateUrl: './hospital-bill-master-form.component.html',
  styleUrls: ['./hospital-bill-master-form.component.css']
})
export class HospitalBillMasterFormComponent {
 @Input()
